    ...
    const [robert] = useState(
        {
            ...
            location: "Minnesota",
            about: "I am a dedicated Software Engineer with a background in both software development and project management. Currently, I am volunteering with Seeds of Success, where I contribute to an AI-driven platform designed to simplify access to resources. I am also pursuing a Bachelor’s degree in Computer Science at Metro State University, aiming to deepen my technical expertise and expand my career opportunities. My professional experience includes frontend and backend development, consulting, and collaborating with cross-functional teams to deliver impactful solutions. As I continue to grow as a software engineer, I am actively seeking new opportunities where I can apply my skills, contribute to meaningful projects, and further my career in technology. Let's connect!"
        }
    );
