    ...
    const [robert] = useState(
        {
            ...
            location: "Minnesota",
            about: "I am a dedicated Software Engineer with a strong background in both software development and project management. Currently, I am volunteering with Seeds of Success, where I contribute to Project CARLA—an AI-driven platform designed to simplify access to mental health and basic needs resources for K12 and college students. In this role, I work across the tech stack, utilizing JavaScript, Express, REST APIs, SQL, and MongoDB, while leading teams and managing Agile processes. I am also pursuing a Bachelor’s degree in Computer Science at Metro State University, aiming to deepen my technical expertise and expand my career opportunities. My professional experience includes frontend and backend development, risk management, and collaborating with cross-functional teams to deliver impactful solutions. As I continue to grow as a software engineer, I am actively seeking new paid opportunities where I can apply my skills, contribute to meaningful projects, and further my career in technology."
        }
    );
